...
public class TC20_VerifyRenewSubscriptionprocess extends TestBase {
	public static final Logger log = Logger.getLogger(TC20_VerifyRenewSubscriptionprocess.class.getName());

	//@BeforeClass
	//public static void startTest() {

		//test = extent.startTest("TC20_VerifyRenewSubscriptionprocess");
	...
	public void clientLogin() throws IOException, InterruptedException, AWTException {
		...
		clp.clientSignIn("ts17045@yopmail.com", "Nilesh@2025");
