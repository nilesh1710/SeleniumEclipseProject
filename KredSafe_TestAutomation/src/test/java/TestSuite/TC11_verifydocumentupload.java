...
public class TC11_verifydocumentupload extends TestBase {
	...
	public void clientLogin() throws IOException, InterruptedException, AWTException {
		...
		clp.clientSignIn(OR.getProperty("emailID12"), OR.getProperty("createAccountPassword12"));
