...
public class TC21_VerifyFormpaymentwhenprofilenotcompleted extends TestBase {
	...
	//	test = extent.startTest("TC21_VerifyFormpaymentwhenprofilenotcompleted");
