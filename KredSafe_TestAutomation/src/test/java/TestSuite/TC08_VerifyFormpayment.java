...
public class TC08_VerifyFormpayment extends TestBase {
	
	public static final Logger log = Logger.getLogger(TC08_VerifyFormpayment.class.getName());
	private static final String By = null;

	//@BeforeClass
	//public static void startTest() {

		//test = extent.startTest("TC08_VerifyFormpayment");
	...
	public void clientLogin() throws IOException, InterruptedException, AWTException {
		...
		clp.clientSignIn(OR.getProperty("emailID5"), OR.getProperty("createAccountPassword5"));
