...
import com.KredSafe.Locations.Locations;
...
public class TestBase {
	...
	public void load_data() throws IOException {
		...
		File config = new File(
				"C:\\New Kredsafe\\KredSafe_TestAutomation (2)\\KredSafe_TestAutomation\\src\\main\\java\\com\\KredSafe\\config\\config.properties");
	...
	public void select_browser(String browser) {
		if (browser.equalsIgnoreCase("firefox")) {
			...
			System.setProperty("webdriver.gecko.driver", "C:\\New Kredsafe\\KredSafe_TestAutomation (2)\\KredSafe_TestAutomation\\drivers/geckodriver.exe");
		...
		if (browser.equalsIgnoreCase("chrome")) {
			...
			System.setProperty("webdriver.chrome.driver",
					"C:\\New Kredsafe\\KredSafe_TestAutomation (2)\\KredSafe_TestAutomation\\drivers\\chromedriver.exe");
			//C:\New Kredsafe\KredSafe_TestAutomation (2)\KredSafe_TestAutomation\drivers
