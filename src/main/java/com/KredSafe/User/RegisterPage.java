...
public class RegisterPage extends TestBase {
	...
	@FindBy(xpath = "//a[@href='#tab_std_res_30']")
	WebElement oneyear;
	
	@FindBy(xpath = "//input[@name='installments' and @value='2']")
	WebElement sixmonth;
	
	@FindBy(xpath = "//input[@type='radio' and @name='installments' and @value='1']")
	WebElement twelvemonth;
	...
	public void subscriptionPlansStandard() throws InterruptedException, IOException {
		try {
			wait_for_page_load(10);
			String get_currenturl = driver.getCurrentUrl();
			System.out.println("Current URL is:" + get_currenturl);
	...
	@FindBy(xpath = "//a[@href='#tab_premium_res_50']")
	WebElement poneyear;
	
	@FindBy(xpath = "//input[@type='radio' and @name='prem_installments' and @data-month='6' and @value='2']")
	WebElement psixmonth;
	
	@FindBy(xpath = "//input[contains(@class, 'prem_radio_12') and contains(@class, 'prem_radio_50') and @value='1']")
	WebElement ptwelvwmonth;
	
	@FindBy(xpath = "//a[@href='#tab_premium_res_48']")
	WebElement pthreeyear;
	
	@FindBy(xpath = "//input[@type='radio' and @name='prem_installments' and @data-month='6' and @value='6']")
	WebElement pthreesixmonthr;
	
	@FindBy(xpath = "//input[@type='radio' and @name='prem_installments' and @data-month='1' and @value='3']")
	WebElement pthreetwelvwmonth;
	
	@FindBy(xpath = "//input[@name='prem_installments' and @data-month='3' and @value='1']")
	WebElement pthreefullpay;
	
	@FindBy(xpath = "//button[@id='subscribe5']")
	WebElement psb;
	
	
	//button[@id='subscribe5']
	
	
	//input[@name='prem_installments' and @data-month='3' and @value='1']

	
	
	//input[@name='prem_installments' and @data-month='1' and @value='3']
	
	
	public void subscriptionPlanspremium() throws InterruptedException, IOException {
		try {
			wait_for_page_load(10);
			String get_currenturl = driver.getCurrentUrl();
			System.out.println("Current URL is:" + get_currenturl);
		...
		try {
			...
			if (get_currenturl.equals("https://dev.kredsafe.net/user/subscriptions")) {
				...
				// scrollDown();
				scrollDownToElement(psb);
				// scrollToElement(subscribeButton);
				// wait_for_element_present(subscribeButton);
				wait_in_seconds(5);
				click_Element_Using_JS(psb);
				// subscribeButton.click();
				wait_for_page_load(10);
				wait_for_element_present(creditCard);
				wait_in_seconds(20);
