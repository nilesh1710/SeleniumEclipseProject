...
public class TC22_VerifyUpgradeSubscriptionprocess extends TestBase {
	public static final Logger log = Logger.getLogger(TC03_verifyProfileDetailsFunctionality.class.getName());

	//@BeforeClass
	//public static void startTest() {

		//test = extent.startTest("TC22_VerifyUpgradeSubscriptionprocess");
	...
	public void clientLogin() throws IOException, InterruptedException, AWTException {
		...
		clp.clientSignIn(OR.getProperty("emailID2"), OR.getProperty("createAccountPassword2"));
