...
public class TC32_VerifyRestorevalidation extends TestBase {
	public static final Logger log = Logger.getLogger(TC32_VerifyRestorevalidation.class.getName());
	...
	public void RestoreValidation() throws IOException, InterruptedException, AWTException, TimeoutException {
