...
public class TC35_Primaryemailupdatealertemail extends TestBase {
	public static final Logger log = Logger.getLogger(TC35_Primaryemailupdatealertemail.class.getName());

	//@BeforeClass
	//public static void startTest() {

	//	test = extent.startTest("TC14_MakePrimaryEmail ");
