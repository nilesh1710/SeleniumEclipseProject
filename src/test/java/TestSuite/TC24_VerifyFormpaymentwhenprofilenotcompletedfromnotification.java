...
public class TC24_VerifyFormpaymentwhenprofilenotcompletedfromnotification extends TestBase {
	...
	//public static void startTest() {
		...
		///test = extent.startTest(" TC24_VerifyFormpaymentwhenprofilenotcompletedfromnotification");
	...
	public void clientLogin() throws IOException, InterruptedException, AWTException {
		...
		clp1.Verifypaymentnotification();
