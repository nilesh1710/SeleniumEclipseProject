...
public class TC37_Verifyexpaenses extends TestBase {
	
	public static final Logger log = Logger.getLogger(TC37_Verifyexpaenses.class.getName());
	...
	public void Expenses() throws IOException, InterruptedException, AWTException {

		log.info("<===========Started Verifying Expenses===========> ");
		openAppUrl();
