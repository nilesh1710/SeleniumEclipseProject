...
public class TC30_VerifySubscriptionprocessStandard extends TestBase {
	public static final Logger log = Logger.getLogger(TC30_VerifySubscriptionprocessStandard.class.getName());
