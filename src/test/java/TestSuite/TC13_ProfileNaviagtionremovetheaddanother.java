...
public class TC13_ProfileNaviagtionremovetheaddanother extends TestBase {
	public static final Logger log = Logger.getLogger(TC03_verifyProfileDetailsFunctionality.class.getName());

	@BeforeClass
	public static void startTest() {

		test = extent.startTest("TC13_ProfileNaviagtionremovetheaddanother");
