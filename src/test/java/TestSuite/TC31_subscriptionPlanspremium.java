...
public class TC31_subscriptionPlanspremium extends TestBase {
	public static final Logger log = Logger.getLogger( TC31_subscriptionPlanspremium.class.getName());
